...
const fileEvaluationTool = tool(
    ...
    },
    {
        ...
        description: 'Retrieves relevant sections from uploaded project PDF documents using vector search in ChromaDB. Pass the project ID and evaluation question/query.',
        schema: z.object({
            projectId: z.string().describe('The database ID of the target project.'),
            query: z.string().describe('The specific query, requirement, or criteria to evaluate against the project files.')
        })
    }
);
